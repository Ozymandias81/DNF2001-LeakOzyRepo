...
class ENGINE_API URenderDevice : public USubsystem
{
	...
	virtual void __fastcall DrawGouraudPolygon( FSceneNode* Frame, FTextureInfo& Info, FTransTexture** Pts, int NumPts, DWORD PolyFlags, FSpanBuffer* Span ) {};
	...
	virtual void __fastcall DrawTile(
							...
							FLOAT Z=0, 
							FPlane InColor=FVector(0,0,0), FPlane Fog=FVector(0,0,0),
							DWORD PolyFlags=0, 
							UBOOL bilinear=0, 
							FLOAT alpha=1.0,
							FLOAT rot=0.0,
	...
	virtual void __fastcall PrecacheTexture( FTextureInfo& Info, DWORD PolyFlags ) {}
