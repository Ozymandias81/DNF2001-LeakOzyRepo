...
# ADD CPP /nologo /Zp4 /MD /W4 /WX /vd0 /GX /Zi /O2 /Ob2 /I "." /I "..\Inc" /I "..\..\Core\Inc" /I "..\..\Engine\Inc" /D WINDOW_API=__declspec(dllexport) /D "_WINDOWS" /D "NDEBUG" /D "UNICODE" /D "_UNICODE" /D "WIN32" /D _WIN32_IE=0x0200 /FR /FD /c
...
# ADD LINK32 ..\..\Core\Lib\Core.lib user32.lib kernel32.lib gdi32.lib advapi32.lib comctl32.lib comdlg32.lib shell32.lib /nologo /base:"0x11000000" /subsystem:windows /dll /incremental:yes /debug /machine:I386 /out:"..\..\System\Window.dll"
...
# ADD CPP /nologo /Zp4 /MDd /W4 /WX /Gm /vd0 /GX /Zi /Od /I "." /I "..\Inc" /I "..\..\Core\Inc" /I "..\..\Engine\Inc" /D "_WINDOWS" /D WINDOW_API=__declspec(dllexport) /D "UNICODE" /D "_UNICODE" /D "_DEBUG" /D "WIN32" /D _WIN32_IE=0x0200 /FD /c
