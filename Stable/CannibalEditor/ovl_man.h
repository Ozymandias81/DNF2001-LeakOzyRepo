...
public:
	...
	virtual boolean OnMouseMove(inputevent_t *event);
	virtual boolean OnPress(inputevent_t *event);
	virtual boolean OnDrag(inputevent_t *event);
	virtual boolean OnRelease(inputevent_t *event);
	virtual boolean OnPressCommand(int argNum, char **argList);
	virtual boolean OnDragCommand(int argNum, char **argList);
	virtual boolean OnReleaseCommand(int argNum, char **argList);
	virtual boolean OnMessage(ovlmsg_t *msg);
	virtual boolean OnDragDrop(overlay_t *dropovl);
};
