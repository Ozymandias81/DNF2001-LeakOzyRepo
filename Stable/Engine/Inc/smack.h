...
//=======================================================================
#define SMACKFROMMEMORY 0x00010L // Load from a memory pointer
...
#define SMACKGETKEYPREVIOUS     0
#define SMACKGETKEYNEXT         1
#define SMACKGETKEYCLOSEST      2
#define SMACKGETKEYNOTEQUAL   128

RADEXPFUNC u32 RADEXPLINK SmackGetKeyFrame(Smack PTR4* smk,u32 frame,s32 flags);
