...
public:
	...
	const TCHAR* GetEscapedOption( const TCHAR* Match, const TCHAR* Default ) const;
	...
	FString UnEscape( const TCHAR *str ) const;
	FString Escape ( const TCHAR *str ) const;
	TCHAR from_hex( TCHAR ) const; 
