//=============================================================================
// dnGrenadeFX_Explosion_LightDebris.                  June 30th, 2000 - Charlie Wiederhold
//=============================================================================
class dnGrenadeFX_Explosion_LightDebris expands dnGrenadeFX;
...
defaultproperties
{
     ...
     InitialVelocity=(Z=1792.000000)
     MaxVelocityVariance=(X=1024.000000,Y=1024.000000,Z=1792.000000)
     ...
     AdditionalSpawn(0)=(SpawnClass=Class'dnGrenadeFX_Explosion_LightDebris_White')
     AdditionalSpawn(1)=(SpawnClass=Class'dnGrenadeFX_Explosion_HeavyDebris')
     AdditionalSpawn(2)=(SpawnClass=Class'dnGrenadeFX_Explosion_Embers')
