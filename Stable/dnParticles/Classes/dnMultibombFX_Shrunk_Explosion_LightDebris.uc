//=============================================================================
// dnMultibombFX_Shrunk_Explosion_LightDebris.                  June 30th, 2000 - Charlie Wiederhold
//=============================================================================
class dnMultibombFX_Shrunk_Explosion_LightDebris expands dnMultibombFX_Shrunk;
...
defaultproperties
{
     ...
     AdditionalSpawn(0)=(SpawnClass=Class'dnMultibombFX_Shrunk_Explosion_LightDebris_White')
     AdditionalSpawn(1)=(SpawnClass=Class'dnMultibombFX_Shrunk_Explosion_HeavyDebris')
     AdditionalSpawn(2)=(SpawnClass=Class'dnMultibombFX_Shrunk_Explosion_Embers')
