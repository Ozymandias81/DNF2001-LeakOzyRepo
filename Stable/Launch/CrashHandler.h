...
----------------------------------------------------------------------*/
BUGSUTIL_DLLINTERFACE char *__stdcall GetFaultReason ( EXCEPTION_POINTERS * pExPtrs ) ;
...
BUGSUTIL_DLLINTERFACE char *__stdcall
...
RETURNS         :
    ...
    NULL  - There was a problem.
----------------------------------------------------------------------*/
BUGSUTIL_DLLINTERFACE char *__stdcall GetRegisterString ( EXCEPTION_POINTERS * pExPtrs ) ;
