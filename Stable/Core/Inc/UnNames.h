...
REGISTER_NAME( 331, Probe31          )
REGISTER_NAME( 332, SpeechTimer      ) // speech timer expired
REGISTER_NAME( 333, MayFall 		 )
REGISTER_NAME( 334, BlockedByMover	 ) // Obstructed by mover that can bee seen through.
...
// Network
REGISTER_NAME( 348, PostNetReceive	 )

REGISTER_NAME( 349, SeeFocalPoint	 )
REGISTER_NAME( 350, FocalPointNotVisible )
