//=============================================================================
// dnDebrisMesh_Cement1. 			  September 21st, 2000 - Charlie Wiederhold
//=============================================================================
class dnDebrisMesh_Cement1 expands dnDebris;

// Root of the cement mesh debris spawners. Normal sized chunks
...
defaultproperties
{
     ...
     DrawType=DT_Mesh
     Mesh=DukeMesh'c_FX.Gib_ConcreteA'
