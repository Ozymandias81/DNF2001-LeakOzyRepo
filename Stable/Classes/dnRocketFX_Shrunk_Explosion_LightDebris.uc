//=============================================================================
// dnRocketFX_Shrunk_Explosion_LightDebris.                  August 8th, 2000 - Charlie Wiederhold
//=============================================================================
class dnRocketFX_Shrunk_Explosion_LightDebris expands dnRocketFX_Shrunk;
...
defaultproperties
{
     ...
     AdditionalSpawn(0)=(SpawnClass=Class'dnRocketFX_Shrunk_Explosion_LightDebris_White')
     AdditionalSpawn(1)=(SpawnClass=Class'dnRocketFX_Shrunk_Explosion_HeavyDebris')
     AdditionalSpawn(2)=(SpawnClass=Class'dnRocketFX_Shrunk_Explosion_Embers')
