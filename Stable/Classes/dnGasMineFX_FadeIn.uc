...
-----------------------------------------------------------------------------*/
class dnGasMineFX_FadeIn expands dnGasMineFX;
...
{
	bIgnited = true;
	spawn( class'dnGasMineFX_Ignition', Instigator,, Location, Rotation );
	Destroy();
}
...
defaultproperties
{
     ...
     bUseAlphaRamp=True
     CollisionRadius=164.000000
     CollisionHeight=164.000000
	 bCollideActors=true
