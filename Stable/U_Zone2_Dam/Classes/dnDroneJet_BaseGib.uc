//=============================================================================
// dnDroneJet_BaseGib.             Created by Charlie Wiederhold April 13, 2000
//=============================================================================
class dnDroneJet_BaseGib expands dnDecorationBigFrag;

// Large gib effect spawner.
// Does NOT do damage. 
// Designed for use with the base part of the Drone Jet.
...
defaultproperties
{
     ...
     bTakeMomentum=False
     Mesh=DukeMesh'c_vehicles.drone_pcs_base'
}
