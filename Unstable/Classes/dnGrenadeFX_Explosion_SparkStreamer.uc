//=============================================================================
// dnGrenadeFX_Explosion_SparkStreamer.	Keith Schuler	4/19/2001
...
//=============================================================================
class dnGrenadeFX_Explosion_SparkStreamer expands dnGrenadeFX;
...
defaultproperties
{
     ...
     AdditionalSpawn(0)=(SpawnClass=Class'dnParticles.dnGrenadeFX_Explosion_SparkStreamer_Trail',TakeParentTag=True,Mount=True)
     AdditionalSpawn(1)=(SpawnClass=Class'dnParticles.dnGrenadeFX_Explosion_SparkStreamer_Smoke',TakeParentTag=True,Mount=True)
