//=============================================================================
// dnDropShip_CrashSplash2. 			October 19th, 2000 - Charlie Wiederhold
//=============================================================================
class dnDropShip_CrashSplash2 expands dnVehicleFX;
...
defaultproperties
{
     ...
     SpawnNumber=8
     Lifetime=2.000000
     InitialVelocity=(Y=2048.000000,Z=300.000000)
     InitialAcceleration=(Z=512.000000)
     MaxVelocityVariance=(X=0.000000,Y=128.000000,Z=256.000000)
