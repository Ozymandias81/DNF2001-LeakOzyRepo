//=============================================================================
// dnRocketFX_Explosion_LightDebris.                  June 30th, 2000 - Charlie Wiederhold
//=============================================================================
class dnRocketFX_Explosion_LightDebris expands dnRocketFX;
...
defaultproperties
{
     ...
     AdditionalSpawn(0)=(SpawnClass=Class'dnParticles.dnRocketFX_Explosion_LightDebris_White')
     AdditionalSpawn(1)=(SpawnClass=Class'dnParticles.dnRocketFX_Explosion_HeavyDebris')
     AdditionalSpawn(2)=(SpawnClass=Class'dnParticles.dnRocketFX_Explosion_Embers')
     SpawnNumber=0
     PrimeCount=45
     MaximumParticles=45
     Lifetime=2.000000
