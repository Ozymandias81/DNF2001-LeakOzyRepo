...
//TLW: Sub-routine added to make DrawTextLine more robust and easier
//		to extend upon
function float FindTextLineStartingPos(Canvas C, String strRow)
{
	...
	if(bHCenter)
	{
		...
		if(VertSB.bWindowVisible)
			return int(((WinWidth - VertSB.WinWidth) - W) / 2);
	//	else
			return int((WinWidth - W) / 2);
	}
//	else
		return 2.0f;	//default offset?
}
