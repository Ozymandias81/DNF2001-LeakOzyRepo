...
public:
	...
	UClass* MetaClass;
	FName OptionNameA, OptionNameB;
	UObject* OptionObjectA, *OptionObjectB;
	...
	FPropertyBase( UProperty* Property )
	{
		...
		else if( Property->GetClass()==UNameProperty::StaticClass() )
		{
			*this = FPropertyBase(CPT_Name);
			OptionNameA = Cast<UNameProperty>(Property)->NameOptionNameA;
			OptionNameB = Cast<UNameProperty>(Property)->NameOptionNameB;
			OptionObjectA = Cast<UNameProperty>(Property)->NameOptionObjectA;
			OptionObjectB = Cast<UNameProperty>(Property)->NameOptionObjectB;
		}
...
public:
	...
	INT				GetConstInt( INT& Result, const TCHAR* Tag=NULL );
