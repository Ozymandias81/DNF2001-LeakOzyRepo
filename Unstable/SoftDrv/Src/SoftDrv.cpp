...
#pragma comment (lib,"user32.lib")	// NJS: Needed to display message box.
...
//
void USoftwareRenderDevice::Lock( FColor FogColor, float FogDensity, INT FogDistance, FPlane InFlashScale, FPlane InFlashFog, FPlane ScreenClear, DWORD RenderLockFlags, BYTE* InHitData, INT* InHitSize )
{
