...
class G_LightSwitch1 expands dnSwitchDecoration;

#exec OBJ LOAD FILE=..\Sounds\a_switch.dfx

defaultproperties
{
     SwitchStates(0)=(AfterSequence=True,Sequence=switchon,Sound=Sound'a_switch.Mechanical.MSwitch116a')
     SwitchStates(1)=(AfterSequence=True,Sequence=switchoff,Sound=Sound'a_switch.Mechanical.MSwitch116a')
     Loop=True
     ...
     Mesh=DukeMesh'c_generic.lightswitch1RC'
